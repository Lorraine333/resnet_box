...
def resnet_model_fn(features, labels, mode, model_class,
  ...
  # mAP = tf.Print(mAP, [mAP], 'mean average precision')
...
def define_resnet_flags(resnet_size_choices=None):
  ...
  # add box flags
  flags.DEFINE_string('cond_file', '/home/xiangl/workspace/synthesis/images/label_constraints2014/cond_prob_no_zero.txt',
                      help=flags_core.help_wrap('conditional training file'))
  flags.DEFINE_string('marg_file', '/home/xiangl/workspace/synthesis/images/label_constraints2014/marg_prob.txt',
